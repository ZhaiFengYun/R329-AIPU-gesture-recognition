...
def main():
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            node = sess.graph.get_tensor_by_name('BatchNorm_5/FusedBatchNormV3:0')

            node2 = sess.graph.get_tensor_by_name('Conv/Conv2D:0')
            ...
            # max_dict['x_input_0'] = 0
            # min_dict['x_input_0'] = 0
            ...
            for rt in range(1):
                ...
                if i_frame % 2 == 0:  # skip every other frame to obtain a suitable frame rate
                    ...
                    # feat, x0a, x1a, x2a, x3a, x4a, x5a, x6a, x7a, x8a, x9a, = \
                    #     sess.run(
                    ...
                    inputd_max = feat.max()
                    inputd_min = feat.min()
                    max_dict['x_input_0'] = np.array(max(max_dict['x_input_0'], inputd_max))
                    min_dict['x_input_0'] = np.array(min(min_dict['x_input_0'], inputd_min))

                    inputd_max = x0a.max()
                    inputd_min = x0a.min()
                    max_dict['x_input0_0'] = np.array(max(max_dict['x_input0_0'], inputd_max))
                    min_dict['x_input0_0'] = np.array(min(min_dict['x_input0_0'], inputd_min))

                    inputd_max = x1a.max()
                    inputd_min = x1a.min()
                    max_dict['x_input1_0'] = np.array(max(max_dict['x_input1_0'], inputd_max))
                    min_dict['x_input1_0'] = np.array(min(min_dict['x_input1_0'], inputd_min))

                    inputd_max = x2a.max()
                    inputd_min = x2a.min()
                    max_dict['x_input2_0'] = np.array(max(max_dict['x_input2_0'], inputd_max))
                    min_dict['x_input2_0'] = np.array(min(min_dict['x_input2_0'], inputd_min))

                    inputd_max = x3a.max()
                    inputd_min = x3a.min()
                    max_dict['x_input3_0'] = np.array(max(max_dict['x_input3_0'], inputd_max))
                    min_dict['x_input3_0'] = np.array(min(min_dict['x_input3_0'], inputd_min))

                    inputd_max = x4a.max()
                    inputd_min = x4a.min()
                    max_dict['x_input4_0'] = np.array(max(max_dict['x_input4_0'], inputd_max))
                    min_dict['x_input4_0'] = np.array(min(min_dict['x_input4_0'], inputd_min))

                    inputd_max = x5a.max()
                    inputd_min = x5a.min()
                    max_dict['x_input5_0'] = np.array(max(max_dict['x_input5_0'], inputd_max))
                    min_dict['x_input5_0'] = np.array(min(min_dict['x_input5_0'], inputd_min))

                    inputd_max = x6a.max()
                    inputd_min = x6a.min()
                    max_dict['x_input6_0'] = np.array(max(max_dict['x_input6_0'], inputd_max))
                    min_dict['x_input6_0'] = np.array(min(min_dict['x_input6_0'], inputd_min))

                    inputd_max = x7a.max()
                    inputd_min = x7a.min()
                    max_dict['x_input7_0'] = np.array(max(max_dict['x_input7_0'], inputd_max))
                    min_dict['x_input7_0'] = np.array(min(min_dict['x_input7_0'], inputd_min))

                    inputd_max = x8a.max()
                    inputd_min = x8a.min()
                    max_dict['x_input8_0'] = np.array(max(max_dict['x_input8_0'], inputd_max))
                    min_dict['x_input8_0'] = np.array(min(min_dict['x_input8_0'], inputd_min))

                    inputd_max = x9a.max()
                    inputd_min = x9a.min()
                    max_dict['x_input9_0'] = np.array(max(max_dict['x_input9_0'], inputd_max))
                    min_dict['x_input9_0'] = np.array(min(min_dict['x_input9_0'], inputd_min))
                    ...
                    # print(feat)
                #     history_logit.append(feat)
                #     print('L1:',len(history_logit))
                #     history_logit = history_logit[-12:]
                #     print('L2:', len(history_logit))
                #     avg_logit = sum(history_logit)
                #     print('avg:',avg_logit)
                #     idx_ = np.argmax(avg_logit, axis=1)[0]
                #     #
